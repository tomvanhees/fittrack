 ...
 * momentopname: nieuwere syncbare tabellen (zoals `goals` en `body_metrics`)
 * regelen hun eigen metadata in de migratie die ze aanmaakt. Zo blijft migratie
 * 3 deterministisch en probeert ze nooit een tabel te wijzigen die op dat punt
 * nog niet bestaat.
 */
...
// ---------- Migratie 7: RPE, dag-notities + lichaamsmetingen ----------

function migration7(db: SQLiteDatabase): void {
